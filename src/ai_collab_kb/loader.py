...
class KnowledgeLoader:
    ...
    DEFAULT_TRIGGERS = [
        LoadingTrigger(
            name="code",
            keywords=[
                "code", "implement", "fix", "refactor", "debug", "bug",
                "代码", "实现", "修复", "重构", "调试", "错误", "函数", "方法",
            ],
            files=["content/guidelines/02_code_style.md", "content/guidelines/05_python.md"],
            timeout_ms=2000,
        ),
        LoadingTrigger(
            name="architecture",
            keywords=[
                "architecture", "design", "system", "scale", "module",
                "架构", "设计", "系统", "扩展", "模块", "组件", "结构",
            ],
        ...
        LoadingTrigger(
            name="testing",
            keywords=[
                "test", "testing", "verify", "validation", "coverage",
                "测试", "验证", "覆盖", "单元测试", "集成测试",
            ],
        ...
        LoadingTrigger(
            ...
            keywords=[
                "autonomy", "collaboration", "instruction", "batch",
                "自主", "协作", "指令", "批处理", "AI", "助手", "等级",
            ],
        ...
        LoadingTrigger(
            ...
            keywords=[
                "decision", "review", "expert", "committee", "evaluate",
                "决策", "评审", "专家", "委员会", "评估", "审查",
            ],
        ...
        LoadingTrigger(
            name="documentation",
            keywords=[
                "document", "doc", "readme", "guide", "changelog",
                "文档", "说明", "指南", "变更日志", "注释",
            ],
        ...
        LoadingTrigger(
            name="python",
            keywords=[
                "python", "decorator", "async", "typing", "pydantic",
                "Python", "装饰器", "异步", "类型", "类型注解",
            ],
        ...
        LoadingTrigger(
            name="quality",
            keywords=[
                "quality", "standard", "best practice", "principle",
                "质量", "标准", "最佳实践", "原则", "规范",
            ],
    ...
    def __init__(
        ...
        timeout_manager: Optional[Any] = None,  # TimeoutManager instance
        triggers: Optional[List[LoadingTrigger]] = None,
    ):
        """
    ...
    async def load(
        ...
        result = await self._load_files_with_timeout(
            files_to_load, timeout_ms
        )
    ...
    def _get_files_for_layer(self, layer: Layer) -> List[str]:
        ...
        for path_str in paths:
            ...
            if path.is_file():
                ...
                files.extend([
                    str(f.relative_to(self.kb_path))
    ...
    def _get_layer_for_file(self, file_path: str) -> Layer:
        ...
        elif "content/guidelines" in file_path or file_path.startswith("content/guidelines"):
            return Layer.L2_GUIDELINES
        elif "content/frameworks" in file_path or file_path.startswith("content/frameworks"):
            return Layer.L3_FRAMEWORKS
        elif "content/practices" in file_path or file_path.startswith("content/practices"):
