...
This document tracks **project-specific calibration data**:

- Historical autonomy level decisions for SAGE project
...
| L2 | Low | 20-40% | Significant review |
| L3 | Medium | 40-60% | Standard review |
| L4 | Medium-High | 60-80% | Light review |
| L5 | High | 80-95% | Minimal review |
| L6 | Full | 95-100% | No review needed |

### 1.3 Project Default

**SAGE Project Default**: L4 (Medium-High) for mature collaboration
...
| **Time to Complete** | Average task completion time | Varies |
...
### 6.2 Production-Impacting Tasks
...
- `.knowledge/frameworks/autonomy/LEVELS.md` — **Authoritative** autonomy level definitions
...
- `.junie/guidelines.md` — Junie collaboration rules
