...
- `.knowledge/practices/ai_collaboration/INTERACTION_PATTERNS.md` — **Authoritative** generic AI collaboration patterns
...
- `.context/intelligence/calibration/CALIBRATION.md` — SAGE calibration data
