...
|-----------------|------------------------------------------|-------------------------------|
| **Autonomy**    | `autonomy/INDEX.md`                      | Autonomy framework overview   |
| **Autonomy**    | `autonomy/LEVELS.md`                     | 6-level autonomy spectrum     |
| **Cognitive**   | `cognitive/INDEX.md`                     | Cognitive framework overview  |
| **Cognitive**   | `cognitive/CONFLICT_RESOLUTION.md`       | Conflict resolution & weights |
| **Cognitive**   | `cognitive/EXPERT_COMMITTEE.md`          | Multi-expert analysis (23 roles) |
| **Cognitive**   | `cognitive/INFORMATION_DENSITY.md`       | Compression vs clarity        |
| **Cognitive**   | `cognitive/ROLE_PERSONA.md`              | Expert role definitions       |
| **Design**      | `design/INDEX.md`                        | Design framework overview     |
| **Design**      | `design/AXIOMS.md`                       | 8 design principles           |
| **Design**      | `design/LAYER_HIERARCHY.md`              | Knowledge layer hierarchy     |
| **Patterns**    | `patterns/INDEX.md`                      | Patterns overview             |
| **Patterns**    | `patterns/COLLABORATION.md`              | AI collaboration patterns     |
| **Patterns**    | `patterns/DECISION.md`                   | Quality angles framework (37) |
...
| **Resilience**  | `resilience/INDEX.md`                    | Resilience framework overview |
...
| Resolve conflicts     | `cognitive/CONFLICT_RESOLUTION.md`       |
| Define expert roles   | `cognitive/ROLE_PERSONA.md`              |
| Optimize content      | `cognitive/INFORMATION_DENSITY.md`       |
| Design guidance       | `design/AXIOMS.md`                       |
| Layer organization    | `design/LAYER_HIERARCHY.md`              |
