...
| Priority      | Files                                                                                      |
|---------------|--------------------------------------------------------------------------------------------|
| **Auto-Load** | `core/PRINCIPLES.md`<br/>`.knowledge/guidelines/ENGINEERING.md`<br/>`.knowledge/practices/engineering/design/API_DESIGN.md` |
| **On-Demand** | `.knowledge/guidelines/SECURITY.md`<br/>`.knowledge/practices/engineering/design/ERROR_HANDLING.md`                       |
...
| Category     | Commands                                                  |
|--------------|-----------------------------------------------------------|
| **Docker**   | `docker-compose up -d`<br/>`docker-compose logs -f service` |
| **API Test** | `curl localhost:8000/health`<br/>`httpie POST :8000/orders` |
