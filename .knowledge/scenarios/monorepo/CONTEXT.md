...
| Priority      | Files                                                                                    |
|---------------|------------------------------------------------------------------------------------------|
| **Auto-Load** | `core/PRINCIPLES.md`<br/>`.knowledge/guidelines/ENGINEERING.md`<br/>`.knowledge/practices/engineering/design/PATTERNS.md` |
| **On-Demand** | `.knowledge/practices/documentation/PROJECT_DIRECTORY_STRUCTURE.md`<br/>`.knowledge/guidelines/CODE_STYLE.md`    |
