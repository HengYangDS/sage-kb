...
| Priority      | Files                                                                                   |
|---------------|-----------------------------------------------------------------------------------------|
| **Auto-Load** | `core/PRINCIPLES.md`<br/>`.knowledge/guidelines/CODE_STYLE.md`<br/>`.knowledge/practices/engineering/design/PATTERNS.md` |
| **On-Demand** | `.knowledge/guidelines/ENGINEERING.md`<br/>`.knowledge/practices/engineering/quality/TESTING_STRATEGY.md`               |
...
| Category  | Commands                                                    |
|-----------|-------------------------------------------------------------|
| **Dev**   | `npm run dev`<br/>`npm start`                                 |
| **Build** | `npm run build`<br/>`npm run preview`                         |
| **Test**  | `npm test`<br/>`npm run test:coverage`<br/>`npm run test:watch` |
| **Lint**  | `npm run lint`<br/>`npm run lint:fix`<br/>`npm run typecheck`   |
| **Deps**  | `npm install`<br/>`npm update`<br/>`npm audit`                  |
