...
| Priority      | Files                                                                                                                            |
|---------------|----------------------------------------------------------------------------------------------------------------------------------|
| **Auto-Load** | `core/PRINCIPLES.md`<br/>`docs/api/PLUGIN_QUICK_REF.md`<br/>`.knowledge/practices/engineering/design/PATTERNS.md`                                      |
| **On-Demand** | `.knowledge/practices/engineering/quality/TESTING_STRATEGY.md`<br/>`.context/decisions/ADR_0008_PLUGIN_SYSTEM.md`<br/>`docs/design/05-plugin-memory.md` |
...
| Directory                   | Purpose                  |
|-----------------------------|--------------------------|
| `src/plugins/`              | Plugin framework core    |
| `src/plugins/bundled/`      | Built-in plugins         |
...
|-------------------|-----------------------------|------------------------------------|
| **PluginBase**    | Base class for all plugins  | `src/plugins/base.py`              |
| **PluginManager** | Plugin lifecycle management | `src/plugins/manager.py`           |
| **HookRegistry**  | Hook point registration     | `src/plugins/hooks.py`             |
...
- `.knowledge/practices/engineering/quality/TESTING_STRATEGY.md` — Testing guide
