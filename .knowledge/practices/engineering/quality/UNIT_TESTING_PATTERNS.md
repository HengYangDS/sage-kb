...
- `.knowledge/practices/engineering/quality/INTEGRATION_TESTING.md` — Integration testing
- `.knowledge/practices/engineering/quality/TESTING_STRATEGY.md` — Testing strategy
