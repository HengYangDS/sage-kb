...
- `.knowledge/practices/engineering/operations/CI_CD.md` — CI/CD pipeline with dependency checks
- `.knowledge/practices/engineering/quality/TESTING_STRATEGY.md` — Testing after updates
