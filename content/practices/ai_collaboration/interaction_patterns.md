...
- `content/practices/ai_collaboration/workflow.md` — AI collaboration workflow
- `content/practices/ai_collaboration/context_management.md` — Context management
- `content/practices/ai_collaboration/session_management.md` — Session management
