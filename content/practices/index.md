...
> **Load Time**: On-demand (~50 tokens)  
> **Budget**: ~1500 tokens  
> **Purpose**: Practical guides for implementation
...
- `documentation/standards.md` — Document structure, writing standards
- `documentation/toc.md` — Table of contents specification
...
- `ai_collaboration/workflow.md` — AI-assisted workflow
- `ai_collaboration/context_management.md` — Context management
- `ai_collaboration/token_optimization.md` — Token efficiency
- `ai_collaboration/knowledge_extraction.md` — Knowledge extraction

## Decision Practices

- `decisions/autonomy_cases.md` — Autonomy level case studies
...
- `guidelines/index.md` — Standards and conventions
- `frameworks/index.md` — Conceptual frameworks
- `templates/index.md` — Document templates

---

*Practices layer — Implementation guidance*
