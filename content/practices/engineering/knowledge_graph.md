...
graph = builder.build_incremental(
    ...
    changed_files=["content/new_file.md"]
)
```
...
graph = builder.build_from_directory(
    include_patterns=["content/core/**", "content/guidelines/**"],
...
file_graph = builder.get_file_graph("content/core/principles.md")
...
sage graph build --path content/    # Build specific path
...
- `content/practices/documentation/knowledge_organization.md` — Content organization
