...
Authentication · Authorization · Encryption · Input validation · Password policies · CORS · Rate limiting · Audit logging
...
**Start Conservative** · **Document Decisions** · **Review Periodically** · **Context Matters** · **When in Doubt → Lower Level**
